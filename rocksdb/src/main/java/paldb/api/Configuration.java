...
public class Configuration implements Serializable {
  ...
  public static final String GUAVA_ENABLED = "cache.guava.enabled";
  
  public static final String GUAVA_CACHE_SIZE = "cache.guava.size";
  
  public static final String GUAVA_CONCURRENT_LEVEL = "cache.concurrent.level";
  ...
  public Configuration() {
    ...
    putWithSystemPropertyDefault(GUAVA_ENABLED, "true");
    putWithSystemPropertyDefault(GUAVA_CACHE_SIZE, "-1");
    putWithSystemPropertyDefault(GUAVA_CONCURRENT_LEVEL, "128");
   ...
   */
  public void registerSerializer(paldb.api.Serializer serializer) {
   ...
   */
  public paldb.api.Serializer getSerializer(Class cls) {
