...
public final class DataInputOutput implements DataInput, DataOutput, ObjectInput, ObjectOutput {
  ...
  public String readUTF()
      throws IOException {
    int len = com.linkedin.paldb.utils.LongPacker.unpackInt(this);
    char[] b = new char[len];
    for (int i = 0; i < len; i++) {
      b[i] = (char) com.linkedin.paldb.utils.LongPacker.unpackInt(this);
    }
  ...
  public void writeUTF(String s)
    ...
    com.linkedin.paldb.utils.LongPacker.packInt(this, len);
    for (int i = 0; i < len; i++) {
      int c = (int) s.charAt(i); //TODO investigate if c could be negative here
      com.linkedin.paldb.utils.LongPacker.packInt(this, c);
    }
  }
